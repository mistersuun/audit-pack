"""Run the existing DBRSFiller for Apr 21, 2026.
...
which:
  ...
  4. Pastes values into Apr tab, day 21 column (skipping formula cells)
"""
import sys
...
G4_CLUB_LOUNGE = 50  # Apr 21 G4 forfait in dollars (same as balancer p-g4)

DR_PDF = r'K:\Audition\04 - April\21-04-2026\DAILY_REV.pdf'
MS_PDF = r'K:\Audition\04 - April\21-04-2026\MARKET_SEGMENT.pdf'
